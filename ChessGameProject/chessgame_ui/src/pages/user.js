...
export function Logout(token) {
    return fetch(DOMAIN + `chessGame/uservalidation/?token=${token}`, {
        method: 'PUT',
        headers: {
            'Access-Control-Allow-Origin' : '*',
            'Content-Type': 'application/json',
...
export function Challenge_by_mail(body, token) {
    return fetch(DOMAIN + `chessGame/gameinstance/?token=${token}`, {
        method: 'POST',
        headers: {
            'Access-Control-Allow-Origin' : '*',
            'Content-Type': 'application/json',
...
export function Get_all_challenges(token) {
    return fetch(DOMAIN + `chessGame/gameinstance/?type=CHALLENGES&&token=${token}`, {
        method: 'GET',
        headers: {
            'Access-Control-Allow-Origin' : '*',
            'Content-Type': 'application/json',
...
export function Get_all_challenged(token) {
    return fetch(DOMAIN + `chessGame/gameinstance/?type=CHALLENGED&&token=${token}`, {
        method: 'GET',
        headers: {
            'Access-Control-Allow-Origin' : '*',
            'Content-Type': 'application/json',
...
export function Get_all_wins(token) {
    return fetch(DOMAIN + `chessGame/gameinstance/?type=WINS&&token=${token}`, {
        method: 'GET',
        headers: {
            'Access-Control-Allow-Origin' : '*',
            'Content-Type': 'application/json',
...
export function Get_all_looses(token) {
    return fetch(DOMAIN + `chessGame/gameinstance/?type=LOOSES&&token=${token}`, {
        method: 'GET',
        headers: {
            'Access-Control-Allow-Origin' : '*',
            'Content-Type': 'application/json',
...
export function Get_all_Playable(token) {
    return fetch(DOMAIN + `chessGame/gameinstance/?type=PLAYABLE&&token=${token}`, {
        method: 'GET',
        headers: {
            'Access-Control-Allow-Origin' : '*',
            'Content-Type': 'application/json',
...
export function Get_all_finished(token) {
    return fetch(DOMAIN + `chessGame/gameinstance/?type=FINISHED&&token=${token}`, {
        method: 'GET',
        headers: {
            'Access-Control-Allow-Origin' : '*',
            'Content-Type': 'application/json',
